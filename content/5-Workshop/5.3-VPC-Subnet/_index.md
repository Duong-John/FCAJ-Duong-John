...
- [1. Create VPC and Subnetting](3.1-create-vpc/)
- [2. Create Gateways](3.2-create-gateways/)
- [3. Configure Route Tables](3.3-configure-route-tables/)
- [4. Set up Security Groups (Zero-Trust)](3.4-setup-security-groups/)
- [5. Create IAM Roles for ECS Fargate](3.5-create-iam-roles/)